...
const services = [
  ...
  },
  {
    ...
    description:
      'Granbury seniors trust us for denture services, dry mouth management, and compassionate care tailored to the unique needs of aging teeth and gums.',
  },
  {
        ...
        <section className="py-14 md:py-20 bg-white" aria-labelledby="map-heading">
          <div className="max-w-4xl mx-auto px-4">
            ...
            <div className="rounded-2xl overflow-hidden border border-border" style={{ height: '400px' }}>
              <LeafletMap lat={32.4421} lng={-97.7942} label="Granbury, TX — Served by F. Lee McLemore, DDS" />
            </div>
