...
const services = [
  ...
  },
  {
    ...
    description:
      'Senior patients in Hudson Oaks trust us for crown repairs, denture care, and treatment of age-related dental concerns like dry mouth and worn enamel.',
  },
  {
        ...
        <section className="py-14 md:py-20 bg-white" aria-labelledby="map-heading">
          <div className="max-w-4xl mx-auto px-4">
            ...
            <div className="rounded-2xl overflow-hidden border border-border" style={{ height: '400px' }}>
              <LeafletMap lat={32.7570} lng={-97.7064} label="Hudson Oaks, TX — Served by F. Lee McLemore, DDS" />
            </div>
