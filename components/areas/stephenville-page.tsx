...
const services = [
  ...
  },
  {
    ...
    description:
      'Stephenville seniors trust our geriatric dentistry team for denture care, crown repairs, and compassionate treatment of age-related dental concerns.',
  },
  {
          ...
          <div className="max-w-4xl mx-auto px-4">
            ...
            <div className="rounded-2xl overflow-hidden border border-border" style={{ height: '400px' }}>
              <iframe
                ...
                title="F. Lee McLemore DDS — 610 Eureka St, Weatherford TX (serving Stephenville)"
