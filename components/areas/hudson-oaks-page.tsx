...
const services = [
  {
    ...
    description:
      'Comprehensive exams, cleanings, fillings, and preventive care for Hudson Oaks residents. We emphasize early detection and long-term oral health for the whole family.',
  },
  {
    label: 'Cosmetic Dentistry',
    href: '/services/cosmetic-dentistry',
    description:
      'Teeth whitening, veneers, and smile makeovers designed for Hudson Oaks patients who want to look their best. Our approach is conservative — enhancing your natural smile without over-treatment.',
  },
  {
    label: 'Pediatric Dentistry',
    href: '/services/pediatric-dentistry',
    description:
      'Kids from Hudson Oaks receive gentle, positive dental experiences. We build trust with young patients through patience and clear explanations at every visit.',
  },
  {
    label: 'Senior Dental Care',
    href: '/services/geriatric-dentistry',
    description:
      'Senior patients in Hudson Oaks trust our geriatric dentistry team for crown repairs, denture care, and treatment of age-related dental concerns like dry mouth and worn enamel.',
  },
  {
    label: 'Special Needs Dentistry',
    href: '/services/special-needs-dentistry',
    description:
      'We accommodate patients with physical, cognitive, or sensory challenges. Every Hudson Oaks resident deserves dignified, thorough dental care in a supportive environment.',
  },
]

const faqs = [
  {
    q: 'How close is your office to Hudson Oaks?',
    a: 'We are located just a few minutes west of Hudson Oaks in Weatherford, easily accessible via I-20.',
  },
  {
    q: 'Do you accept patients from the Hudson Oaks area?',
    a: 'Absolutely. Many of our patients live in Hudson Oaks and Willow Park. We are happy to serve families from across eastern Parker County.',
  },
  {
    q: 'What should I do if I have a toothache over the weekend?',
    a: 'Call our office first thing Monday morning and we will prioritize getting you in. For severe pain, our voicemail provides guidance for after-hours emergencies.',
  },
  {
    q: 'Can I schedule multiple family members at once?',
    a: 'Yes. We regularly book family blocks so everyone can be seen in one trip. Let us know when you call and we will coordinate the appointments.',
  },
  {
    q: 'Do you offer cosmetic consultations?',
    a: 'Yes. If you are interested in whitening, veneers, or other cosmetic work, schedule a consultation and we will discuss your options with no pressure.',
  },
]
      ...
      <main id="main-content">
        ...
        >
          <div className="max-w-4xl mx-auto px-4">
            ...
            <p className="text-white/90 text-lg leading-relaxed max-w-2xl text-pretty mb-8">
              Hudson Oaks residents trust F. Lee McLemore, DDS for convenient, quality dental care
              just minutes from home. Our full-service Weatherford practice handles everything from
              routine checkups to cosmetic enhancements and specialized treatment.
            </p>
        ...
        <section className="py-12 bg-white border-b border-border">
          <div className="max-w-4xl mx-auto px-4">
            <p className="text-muted-foreground leading-relaxed text-base max-w-3xl">
              Hudson Oaks sits along I-20 between Weatherford and Fort Worth, making it easy for residents
              to reach our office in just a few minutes. We serve busy professionals, young families, and
              retirees from across this growing community.
            </p>
          </div>
        </section>
        ...
        >
          <div className="max-w-4xl mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-6">
            <div>
              ...
              >
                Ready to schedule from Hudson Oaks?
              </h2>
        ...
        <section className="py-14 md:py-20 bg-white" aria-labelledby="map-heading">
          <div className="max-w-4xl mx-auto px-4">
            ...
            >
              Serving Hudson Oaks from Weatherford
            </h2>
            <p className="text-muted-foreground leading-relaxed mb-6">
              Our office is just west of Hudson Oaks in Weatherford, with free on-site parking and easy I-20 access.
            </p>
            <div className="rounded-2xl overflow-hidden border border-border" style={{ height: '400px' }}>
              <iframe
                ...
                title="F. Lee McLemore DDS — 610 Eureka St, Weatherford TX (serving Hudson Oaks)"
        ...
        <section className="py-14 md:py-20 bg-surface" aria-labelledby="faq-heading">
          <div className="max-w-4xl mx-auto px-4">
            <h2
              ...
              className="font-serif text-2xl md:text-3xl font-bold text-foreground text-balance mb-10"
            >
              Common Questions from Hudson Oaks Patients
            </h2>
