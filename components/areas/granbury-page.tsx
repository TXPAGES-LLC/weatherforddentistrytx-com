...
const services = [
  {
    ...
    description:
      'Comprehensive exams, cleanings, fillings, and preventive care for Granbury families. We build lasting relationships through consistent, thorough dental care.',
  },
  {
    label: 'Cosmetic Dentistry',
    href: '/services/cosmetic-dentistry',
    description:
      'Teeth whitening, veneers, and smile makeovers for Granbury residents who want to look their best. Our conservative approach enhances your natural smile.',
  },
  {
    label: 'Pediatric Dentistry',
    href: '/services/pediatric-dentistry',
    description:
      'Kids from Granbury receive gentle, patient-centered dental care. We make visits positive and educational so children develop healthy habits early.',
  },
  {
    label: 'Senior Dental Care',
    href: '/services/geriatric-dentistry',
    description:
      'Granbury seniors trust our geriatric dentistry team for denture services, dry mouth management, and compassionate care tailored to the unique needs of aging teeth and gums.',
  },
  {
    label: 'Special Needs Dentistry',
    href: '/services/special-needs-dentistry',
    description:
      'Patients with physical, developmental, or cognitive differences receive unhurried, adaptive care. We modify our approach to meet each Granbury patient where they are.',
  },
]

const faqs = [
  {
    q: 'How long is the drive from Granbury to your office?',
    a: 'Our Weatherford office is about 25-30 minutes north of Granbury via US-377. Many Granbury residents find us more convenient than driving into Fort Worth.',
  },
  {
    q: 'Do you accept patients from Hood County?',
    a: 'Yes — we welcome patients from Granbury, Tolar, Lipan, and other Hood County communities.',
  },
  {
    q: 'What if I need emergency dental care?',
    a: 'Call us as early as possible. We reserve time for same-day emergencies and will do our best to see you promptly.',
  },
  {
    q: 'Do you offer payment options for uninsured patients?',
    a: 'Yes. We offer competitive self-pay rates and can discuss payment plans for larger treatments.',
  },
  {
    q: 'Can you treat patients who are anxious about dental visits?',
    a: 'Absolutely. We go at your pace, explain each step, and create a calm environment for nervous patients.',
  },
]
      ...
      <main id="main-content">
        ...
        >
          <div className="max-w-4xl mx-auto px-4">
            ...
            <p className="text-white/90 text-lg leading-relaxed max-w-2xl text-pretty mb-8">
              Granbury residents looking for quality dental care are welcome at F. Lee McLemore, DDS.
              Our Weatherford practice offers comprehensive services — from routine cleanings to specialized
              care for seniors and patients with unique needs — just a short drive north on US-377.
            </p>
        ...
        <section className="py-12 bg-white border-b border-border">
          <div className="max-w-4xl mx-auto px-4">
            <p className="text-muted-foreground leading-relaxed text-base max-w-3xl">
              Granbury is the Hood County seat, known for its historic town square and beautiful lakeside
              setting. Our Weatherford office provides Granbury families with convenient access to experienced
              dental care without the long drive to the Fort Worth metro area.
            </p>
          </div>
        </section>
        ...
        >
          <div className="max-w-4xl mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-6">
            <div>
              ...
              >
                Ready to schedule from Granbury?
              </h2>
        ...
        <section className="py-14 md:py-20 bg-white" aria-labelledby="map-heading">
          <div className="max-w-4xl mx-auto px-4">
            ...
            >
              Serving Granbury from Weatherford
            </h2>
            <p className="text-muted-foreground leading-relaxed mb-6">
              Our office is about 25-30 minutes north of Granbury via US-377. Free parking available on-site.
            </p>
            <div className="rounded-2xl overflow-hidden border border-border" style={{ height: '400px' }}>
              <iframe
                ...
                title="F. Lee McLemore DDS — 610 Eureka St, Weatherford TX (serving Granbury)"
        ...
        <section className="py-14 md:py-20 bg-surface" aria-labelledby="faq-heading">
          <div className="max-w-4xl mx-auto px-4">
            <h2
              ...
              className="font-serif text-2xl md:text-3xl font-bold text-foreground text-balance mb-10"
            >
              Common Questions from Granbury Patients
            </h2>
