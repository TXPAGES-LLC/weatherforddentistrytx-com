...
const services = [
  ...
  },
  {
    ...
    description:
      'Springtown seniors trust us for denture services, crown repairs, and compassionate treatment for age-related dental challenges like dry mouth and root decay.',
  },
  {
        ...
        <section className="py-14 md:py-20 bg-white" aria-labelledby="map-heading">
          <div className="max-w-4xl mx-auto px-4">
            ...
            <div className="rounded-2xl overflow-hidden border border-border" style={{ height: '400px' }}>
              <LeafletMap lat={32.9657} lng={-97.6839} label="Springtown, TX — Served by F. Lee McLemore, DDS" />
            </div>
