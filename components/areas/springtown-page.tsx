...
const services = [
  {
    ...
    description:
      'Complete dental exams, cleanings, and preventive treatments for Springtown families. We build long-term relationships with patients and catch problems before they become painful or expensive.',
  },
  {
    label: 'Cosmetic Dentistry',
    href: '/services/cosmetic-dentistry',
    description:
      'Professional teeth whitening, veneers, and smile enhancements are available to Springtown residents. We deliver natural-looking results you can feel confident about.',
  },
  {
    label: 'Pediatric Dentistry',
    href: '/services/pediatric-dentistry',
    description:
      'Kids from Springtown ISD get gentle, patient-centered dental care. Our team makes visits fun and educational to set children up for a lifetime of healthy smiles.',
  },
  {
    label: 'Senior Dental Care',
    href: '/services/geriatric-dentistry',
    description:
      'Springtown seniors trust our geriatric dentistry team for denture services, crown repairs, and compassionate treatment for age-related dental challenges like dry mouth and root decay.',
  },
  {
    label: 'Special Needs Dentistry',
    href: '/services/special-needs-dentistry',
    description:
      'We provide adaptive, patient-paced care for individuals with physical, developmental, or sensory needs. Every Springtown patient deserves respectful, thorough dental treatment.',
  },
]

const faqs = [
  {
    q: 'How far is your office from Springtown?',
    a: 'Our Weatherford office is about 20 minutes south of Springtown via TX-51. It is a quick trip for families looking for experienced dental care.',
  },
  {
    q: 'Do you see patients without dental insurance?',
    a: 'Yes. We offer competitive self-pay rates and can discuss payment plans for larger treatments. Quality dental care should be accessible to everyone.',
  },
  {
    q: 'What ages do you treat at your practice?',
    a: 'We see patients of all ages — from toddlers getting their first checkup to seniors needing denture adjustments.',
  },
  {
    q: 'Can I bring my kids after school hours?',
    a: 'We are open until 5 pm Monday through Thursday, which allows time for after-school appointments. Call ahead to reserve a convenient slot.',
  },
  {
    q: 'Do you handle dental emergencies for Springtown residents?',
    a: 'Yes. If you have a dental emergency, call us as early as possible and we will work to see you the same day.',
  },
]

export default function SpringtownPage() {
  return (
    <>
      <SiteHeader />
      <main id="main-content">
        ...
        >
          <div className="max-w-4xl mx-auto px-4">
            ...
            <p className="text-white/90 text-lg leading-relaxed max-w-2xl text-pretty mb-8">
              Springtown families count on F. Lee McLemore, DDS for reliable dental care close to home.
              Our Weatherford practice offers everything from routine cleanings to specialized treatment
              for children, seniors, and patients with unique needs.
            </p>
        ...
        <section className="py-12 bg-white border-b border-border">
          <div className="max-w-4xl mx-auto px-4">
            <p className="text-muted-foreground leading-relaxed text-base max-w-3xl">
              Springtown is a growing community in northern Parker County known for its small-town feel
              and strong school district. Our Weatherford office is a short drive south on TX-51, offering
              Springtown residents an easy alternative to busier clinics in the Fort Worth metro area.
            </p>
          </div>
        </section>
        ...
        >
          <div className="max-w-4xl mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-6">
            <div>
              ...
              >
                Ready to schedule from Springtown?
              </h2>
        ...
        <section className="py-14 md:py-20 bg-white" aria-labelledby="map-heading">
          <div className="max-w-4xl mx-auto px-4">
            ...
            >
              Serving Springtown from Weatherford
            </h2>
            <p className="text-muted-foreground leading-relaxed mb-6">
              Our office is about 20 minutes south of Springtown via TX-51. Free parking available on-site.
            </p>
            <div className="rounded-2xl overflow-hidden border border-border" style={{ height: '400px' }}>
              <iframe
                ...
                title="F. Lee McLemore DDS — 610 Eureka St, Weatherford TX (serving Springtown)"
        ...
        <section className="py-14 md:py-20 bg-surface" aria-labelledby="faq-heading">
          <div className="max-w-4xl mx-auto px-4">
            <h2
              ...
              className="font-serif text-2xl md:text-3xl font-bold text-foreground text-balance mb-10"
            >
              Common Questions from Springtown Patients
            </h2>
