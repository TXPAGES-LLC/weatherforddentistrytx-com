...
const services = [
  {
    ...
    description:
      'Comprehensive exams, cleanings, fillings, and preventive care for Aledo families. We catch problems early and keep your teeth healthy year after year with personalized preventive care.',
  },
  {
    label: 'Cosmetic Dentistry',
    href: '/services/cosmetic-dentistry',
    description:
      'Brighten your smile with professional whitening, porcelain veneers, or cosmetic bonding. Aledo patients appreciate our natural-looking results and conservative treatment approach.',
  },
  {
    label: 'Pediatric Dentistry',
    href: '/services/pediatric-dentistry',
    description:
      'Kids from Aledo ISD families trust us for gentle, kid-friendly dental visits. We focus on education, prevention, and making the dentist a positive experience from the start.',
  },
  {
    label: 'Senior Dental Care',
    href: '/services/geriatric-dentistry',
    description:
      'Older adults in Aledo receive specialized geriatric dentistry attention for age-related dental concerns including denture care, dry mouth management, and gentle treatment for sensitive teeth.',
  },
  {
    label: 'Special Needs Dentistry',
    href: '/services/special-needs-dentistry',
    description:
      'We welcome patients with developmental, cognitive, or physical differences. Our team adapts to each individual, ensuring comfortable and respectful care for Aledo families with special needs.',
  },
]

const faqs = [
  {
    q: 'How far is your office from Aledo?',
    a: 'Our Weatherford office is about 10 minutes east of Aledo via I-20. Many Aledo families find us more convenient than driving into Fort Worth.',
  },
  {
    q: 'Do you see children from Aledo ISD?',
    a: 'Yes — we see kids of all ages and work around school schedules. Early morning and after-school appointments are available.',
  },
  {
    q: 'What if I have a dental emergency in Aledo?',
    a: 'Call us right away at (817) 596-4040. We reserve time for same-day emergencies and can usually see urgent cases the morning you call.',
  },
  {
    q: 'Do you accept dental insurance for Aledo patients?',
    a: 'We accept most major dental insurance plans. Our front desk will verify your coverage and explain your benefits before treatment.',
  },
  {
    q: 'Can the whole family be seen on the same day?',
    a: 'Absolutely. We regularly book back-to-back family appointments so everyone can be checked in one trip.',
  },
]
      ...
      <main id="main-content">
        ...
        >
          <div className="max-w-4xl mx-auto px-4">
            ...
            <p className="text-white/90 text-lg leading-relaxed max-w-2xl text-pretty mb-8">
              Aledo families have trusted F. Lee McLemore, DDS for quality dental care just minutes from home.
              From routine checkups to cosmetic enhancements, our Weatherford office serves Aledo residents
              with the same attention we give our own neighbors.
            </p>
        ...
        <section className="py-12 bg-white border-b border-border">
          <div className="max-w-4xl mx-auto px-4">
            <p className="text-muted-foreground leading-relaxed text-base max-w-3xl">
              Aledo is one of the fastest-growing communities in Parker County, known for excellent schools
              and a tight-knit atmosphere. Our practice is a short drive east on I-20, making it easy for
              Aledo families to access full-service dental care without the congestion of the Metroplex.
            </p>
          </div>
        </section>
        ...
        <section className="py-14 md:py-20 bg-white" aria-labelledby="map-heading">
          <div className="max-w-4xl mx-auto px-4">
            ...
            >
              Serving Aledo from Weatherford
            </h2>
            <p className="text-muted-foreground leading-relaxed mb-6">
              Our office in Weatherford is just a quick drive from Aledo — about 10 minutes via I-20 East.
        ...
        <section className="py-14 md:py-20 bg-surface" aria-labelledby="faq-heading">
          <div className="max-w-4xl mx-auto px-4">
            <h2
              ...
              className="font-serif text-2xl md:text-3xl font-bold text-foreground text-balance mb-10"
            >
              Common Questions from Aledo Patients
            </h2>
