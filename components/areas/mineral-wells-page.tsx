...
const services = [
  ...
  },
  {
    ...
    description:
      'Seniors in Mineral Wells trust our geriatric dentistry team for denture adjustments, dry mouth solutions, and compassionate care tailored to the unique needs of aging teeth and gums.',
  },
  {
          ...
          <div className="max-w-4xl mx-auto px-4">
            ...
            <div className="rounded-2xl overflow-hidden border border-border" style={{ height: '400px' }}>
              <iframe
                ...
                title="F. Lee McLemore DDS — 610 Eureka St, Weatherford TX (serving Mineral Wells)"
